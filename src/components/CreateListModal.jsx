    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      {items.map((item, index) => (
        ...
        >
          <div className="flex justify-between items-center">
            <h3>
              <em className="bg-black text-white mr-2 ">1</em>Add item details
            </h3>
      ...
      <div className="flex gap-2 mt-4">
        <div className="flex gap-2">
          ...
          <div>
            <h3>N0.00</h3>
            <input type="text" placeholder="Total cost" className="w-1/2" />
          </div>
        </div>
        <div className="flex gap-2 ml-16  ">
          <button className=" bg-gray-300 py-2 rounded-lg p-2 ">
            <img src="save.png" alt="save" className="w-12" />
            <span className="hidden lg:block text-sm">Save</span>
          </button>

          <button className="lg:flex  bg-orange-500 text-white py-2 rounded-lg p-1 ">
            <h3 className="w-8 ">⬇️</h3>
